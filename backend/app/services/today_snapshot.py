...
def today_snapshot() -> dict:
    """Snapshot HOY vs 7d/30d/365d para los KPIs estrategicos cross-unidad."""
    ...
    # --- Suscripciones cobradas Unidrop (Talo + MELI subs) por dia ---
    ...
    # --- Devoluciones Unidev por dia (si esta disponible) ---
    try:
